...
namespace MedicalCenter.Migrations
{
    ...
    [Migration("20260522202724_AddReferralAndNewDataSeed")]
    partial class AddReferralAndNewDataSeed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedicalCenter.Models.DoctorDepartment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DepartmentId = new Guid("44444444-1111-1111-1111-111111111111"),
                            DoctorId = new Guid("66666666-1111-1111-1111-111111111111")
                        },
                        new
                        {
                            Id = new Guid("77777777-2222-2222-2222-222222222222"),
                            DepartmentId = new Guid("44444444-2222-2222-2222-222222222222"),
                            DoctorId = new Guid("66666666-1111-1111-1111-111111111111")
                        });
                });

            modelBuilder.Entity("MedicalCenter.Models.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MedicalCenter.Models.MedicalLeave", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MedicalCenter.Models.OrderRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MedicalCenter.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddressId = new Guid("55555555-1111-1111-1111-111111111111"),
            ...
            modelBuilder.Entity("MedicalCenter.Models.Referral", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
